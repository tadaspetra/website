...
const cards: AchievementCard[] = [
  {
    ...
    rotateZ: -3,
    wrapperClassName:
      "sm:w-[34%] sm:translate-x-8 sm:translate-y-6 md:w-[38%] md:translate-x-12",
  },
  {
  ...
  },
  {
    ...
    imageClassName:
      "h-full w-full translate-x-[5%] object-cover [clip-path:inset(0_24%_0_14%)]",
    rotateZ: 4,
    wrapperClassName:
      "sm:w-[34%] sm:-translate-x-8 sm:translate-y-1 md:w-[37%] md:-translate-x-12",
  },
];
...
function AchievementCardItem({ card }: AchievementCardProps) {
  return (
    <div className={card.wrapperClassName}>
      <figure
        className="mx-auto w-full max-w-[21rem] rounded-2xl border border-neutral-200 bg-white px-2 pt-2 pb-3 shadow-lg shadow-neutral-200/60 sm:max-w-none dark:shadow-black/40"
        style={{ transform: `rotate(${card.rotateZ ?? 0}deg)` }}
      >
